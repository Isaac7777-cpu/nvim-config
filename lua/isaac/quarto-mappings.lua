...
wk.add({
	{
		{ "<leader>w", group = "sessions", icon = { icon = "󰆦", color = "cyan" } },
		...
		{ "<leader>gic", ":GitConflictRefresh<cr>", desc = "[c]onflict" },
		{ "<leader>gid", group = "[d]iff" },
		{ "<leader>gidc", ":DiffviewClose<cr>", desc = "[c]lose" },
		{ "<leader>gido", ":DiffviewOpen<cr>", desc = "[o]pen" },
		{ "<leader>gis", ":Gitsigns<cr>", desc = "git [s]igns" },
		{
			"<leader>giwc",
