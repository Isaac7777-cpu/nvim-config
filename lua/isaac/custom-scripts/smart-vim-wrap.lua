...
local function on()
	...
	vim.keymap.set("x", "0", "g0", { noremap = true, silent = true })
	vim.keymap.set("x", "^", "g^", { noremap = true, silent = true })
	vim.keymap.set("x", "$", "g$", { noremap = true, silent = true })
	vim.keymap.set("x", "A", "g$a", { noremap = true, silent = true })
end
...
local function off()
	...
	pcall(vim.keymap.del, "x", "j")
	pcall(vim.keymap.del, "x", "k")
	pcall(vim.keymap.del, "x", "0")
